...
export class ProductMongoManager {
  ...
  async getAllProduct() {
    ...
    if (prod) 
      ...
      return {message: "ERROR", rdo: "No existen productos en la base de datos"}
  }
  ...
  async addProduct(producto) {
    try {
      ...
      const resultado = await this.getAllProduct()
      ...
      const newProduct = {...producto, owner: producto.owner || 'admin'}
